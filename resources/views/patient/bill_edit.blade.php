                ...
                <table id="items" class="table detail-table">
                    ...
                    @foreach (json_decode($payment->service_name) as $service)
                        ...
                        <tr>
                            ...
                            <td><input required type="number" class="form-control reg_rate" value="{{$service->rate}}" name="service[{{$count}}][rate]"></td>
                            <td><input required type="number" class="form-control reg_unit" value="{{$service->unit}}" name="service[{{$count}}][unit]"></td>

                            <td><input required type="number" value="{{$service->amount}}" class="form-control reg_amount" name="service[{{$count}}][amount]"></td>
...
{{--                    <tr class="item-row">--}}
{{--                        <td></td>--}}
{{--                        <td class="description"><input required type="text" class="form-control" name="service[{{$count}}][desc]"></td>--}}
{{--                        <td><input required type="number" class="form-control reg_rate" name="service[{{$count}}][rate]"></td>--}}
{{--                        <td><input required type="number" class="form-control reg_unit" name="service[{{$count}}][unit]"></td>--}}
{{--                        <td><input required type="number" class="form-control reg_amount" name="service[{{$count}}][amount]"></td>--}}
{{--                        <td><button type="button" class="delete btn btn-sm btn-danger">Remove</button></td>--}}
{{--                    </tr>--}}
