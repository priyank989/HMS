                                            ...
                                            <table id="example1" class="table table-bordered table-striped dataTable"
                                                ...
                                                @foreach ($patients as $patient)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{$patient->payment_id ? route('billpdf',[$patient->id, $patient->doctor_id,$patient->ipd,$patient->payment_id]) : route('pbill',[$patient->id])}}">{{$patient->payment_id ? 'Bill PDF' : 'Bill Genrate' }}</a>
