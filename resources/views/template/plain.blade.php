...
<head>
    ...
    <title>Shree Pradhaan Hospital | @yield('title')</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header skin-green">
            ...
            <a href="/" class="logo">
                ...
                <span class="logo-lg">Shree Pradhaan Hospital</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{date('Y')}} <a href="#">Shree Pradhaan Hospital Systems</a>.</strong> All rights reserved.
        </footer>
